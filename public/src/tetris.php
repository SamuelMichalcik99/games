    ...
    <div id="web-wrapper">
        ...
        <div id="game-wrapper">
            <div class="inside-column-wrapper">
                <canvas id="tetris-board" width="250" height="500"></canvas>
                <div class="notif-wrapper">
                    <p id="notif"></p>
                </div>
            </div>
            <div id="score-wrapper">
                <div class="tetris-next-canvas-wrapper">
                    <h2>Next tetrominoes:</h2>
                    <canvas id="next-tetrominoes" width="300" height="125"></canvas>
                </div>
