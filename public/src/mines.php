...
<body>
        ...
        <div id="game-wrapper">
            ...
            <div id="score-wrapper">
                <div class="inside-row-wrapper">
                    ...
                    <span id="mines-number" class="title-M">25</span>
                </div>
                <div id="game-flag-btns" class="inside-row-wrapper">
                    <h3>Left click - reveal a cell</h3>
                    <h3>Right click - set a flag</h3>
                </div>
                <div class="inside-row-wrapper">
                    <h2>Your actual time: </h2>
                    <span id="actual-score" class="title-M">0:00</span>
                </div>
                <div class="inside-row-wrapper">
                    <h3>Your best time: </h3>
                    <span id="highest-score" class="title-S">0:00</span>
                </div>
    ...
    <audio id="mine-sound" src="../media/bomb.mp3"></audio>
